...
class DatasetsRegister(object):
    ...
    _all_datasets =  {
        ...
        "BERT4rec.dunnhumby": lambda: get_bert4rec_dataset("dunnhumby"),
        "BERT4rec.instacart": lambda: get_bert4rec_dataset("instacart"),
        "BERT4rec.tafeng": lambda: get_bert4rec_dataset("tafeng"),
